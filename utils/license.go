...
func GetClientLicense(l *model.License) map[string]string {
	...
	if l != nil {
		...
		props["LDAP"] = true //strconv.FormatBool(*l.Features.LDAP)
		props["LDAPGroups"] = true //strconv.FormatBool(*l.Features.LDAPGroups)
		props["MFA"] = true //strconv.FormatBool(*l.Features.MFA)
		props["SAML"] = true //strconv.FormatBool(*l.Features.SAML)
		props["Cluster"] = true //strconv.FormatBool(*l.Features.Cluster)
		props["Metrics"] = true //strconv.FormatBool(*l.Features.Metrics)
		props["GoogleOAuth"] = true //strconv.FormatBool(*l.Features.GoogleOAuth)
		props["Office365OAuth"] = true //strconv.FormatBool(*l.Features.Office365OAuth)
		props["Compliance"] = true //strconv.FormatBool(*l.Features.Compliance)
		props["MHPNS"] = true //strconv.FormatBool(*l.Features.MHPNS)
		props["Announcement"] = true //strconv.FormatBool(*l.Features.Announcement)
		props["Elasticsearch"] = true //strconv.FormatBool(*l.Features.Elasticsearch)
		props["DataRetention"] = true /strconv.FormatBool(*l.Features.DataRetention)
		props["IDLoadedPushNotifications"] = true //strconv.FormatBool(*l.Features.IDLoadedPushNotifications)
